...
UPDATE distributors SET "createdAt" = NOW() WHERE "createdAt" IS NULL;
UPDATE distributors SET "updatedAt" = NOW() WHERE "updatedAt" IS NULL;
...
ALTER TABLE IF EXISTS tenants
  ...
  ALTER COLUMN "createdAt" SET DEFAULT NOW(),
  ALTER COLUMN "updatedAt" SET DEFAULT NOW();
UPDATE tenants SET "createdAt" = NOW() WHERE "createdAt" IS NULL;
UPDATE tenants SET "updatedAt" = NOW() WHERE "updatedAt" IS NULL;
